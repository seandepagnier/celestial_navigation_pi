...
//      m_pSightListCtrl->InsertColumn(rmLUNAR_TIME_OFFSET, _("Lunar Time Offset"));
      ...
      btnWarp = new wxButton(this, -1, _("&Warp to Sight"));
      bsSightButtons->Add(btnWarp, 0, wxALL|wxEXPAND, DIALOG_MARGIN);
      btnWarp->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                         wxCommandEventHandler(CelestialNavigationDialog::OnWarpClick), NULL, this);
...
void CelestialNavigationDialog::OnWarpClick(wxCommandEvent &event)
{
      long selected_index = m_pSightListCtrl->GetNextItem(-1, wxLIST_NEXT_ALL, wxLIST_STATE_SELECTED);
