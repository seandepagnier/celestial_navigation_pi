...
////@begin SightDialog content construction
    ...
    itemBox->Add(itemNotebook, 1, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);
    ...
    itemGrid1->Add(new wxStaticText( itemPanel1, wxID_STATIC, _("Type"), wxDefaultPosition, wxDefaultSize, 0 ), 0, wxALIGN_LEFT|wxLEFT|wxRIGHT|wxTOP, 5);

    m_typeChoice = new wxChoice( itemPanel1, ID_SIGHTDIALOG_TYPE_SET );
    itemGrid1->Add(m_typeChoice, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT|wxTOP, 5);
...
//    m_typeChoice->Append(_T("Lunar  (angle between 2 bodies)"));
    ...
    itemGrid1->Add(new wxStaticText( itemPanel1, wxID_STATIC, _(""), wxDefaultPosition, wxDefaultSize, 0 ), 0, wxALIGN_LEFT|wxLEFT|wxRIGHT|wxTOP, 5);
...
*/
    ...
    itemGrid1->Add(new wxStaticText( itemPanel1, wxID_STATIC, _("Measurement:"),
                   ...
                   0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    m_dateCalendar = new wxCalendarCtrl(itemPanel2, ID_SIGHTDIALOG, now);
    ...
    itemBox2112->Add(new wxStaticText( itemPanel2, wxID_STATIC, _("Time Accuracy"),
                     ...
                     wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 3);
    ...
    itemGrid3->Add(new wxStaticText( itemPanel3, wxID_STATIC, _("Transparency"),
                                     wxDefaultPosition, wxDefaultSize, 0), 0,
                   wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 3);
    m_transparencyText = MakeTextLabelPair( itemPanel3, itemGrid3, _T("75"), _T("%"));
    ...
    m_Color = new wxStaticText( itemPanel3, wxID_STATIC, _(" OOOO "),
                                wxDefaultPosition, wxDefaultSize, 0 );
    itemGrid3->Add(m_Color, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT|wxTOP, 5);
                                             ...
                                             wxString labelvalue)
{
    ...
    sizer->Add(text_sizer, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    wxStaticText* itemStaticText = new wxStaticText( dialog, wxID_STATIC, labelvalue,
                                                    wxDefaultPosition, wxDefaultSize, 0 );
    text_sizer->Add(itemStaticText, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    return ret;
}
                                           ...
                                           wxString labelvalue)
{
    ...
    sizer->Add(choice_sizer, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);

   wxStaticText* itemStaticText = new wxStaticText( dialog, wxID_STATIC, labelvalue,
                                                    wxDefaultPosition, wxDefaultSize, 0 );
   choice_sizer->Add(itemStaticText, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
...
//   sight->m_DateTime.ToUTC();
   ...
   m_transparencyText->SetValue(wxString::Format(_T("%f"), sight->m_Colour.Alpha()*100.0/255));
...
Sight *SightDialog::MakeNewSight()
{
   ...
   double transparency, height, temperature, pressure;

   m_timeCertaintyText->GetValue().ToDouble(&timecertainty);
   m_transparencyText->GetValue().ToDouble(&transparency);
   ...
   wxColour fc = m_Color->GetForegroundColour();
   wxColour c(fc.Red(), fc.Green(), fc.Blue(), transparency / 100  * 255);
   ...
   case ALTITUDE:
      return new AltitudeSight(m_bodiesChoice->GetStringSelection(),
                               ...
                               height, temperature, pressure, c);
   case AZIMUTH:
      return new AzimuthSight(m_bodiesChoice->GetStringSelection(),
                               DateTime(), timecertainty,
                               measurement, measurementcertainty,
                               m_azimuthMagneticNorth->GetValue(), c);
/*   case LUNAR:
