...
////@begin FindBodyDialog content construction
    ...
    itemGrid->Add(m_Latitude, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT|wxTOP, 5);
    ...
    itemGrid->Add(m_Longitude, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT|wxTOP, 5);

    m_azimuthMagneticNorth = new wxCheckBox( itemDialog1, ID_FINDBODYDIALOG_UPDATE_CHECK, _("Magnetic North"),
                                             wxDefaultPosition, wxDefaultSize, 0);
    itemGrid->Add(m_azimuthMagneticNorth, 1, wxALIGN_RIGHT, 5);
